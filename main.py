...
label_temperature = tk.Label(info_block, text=f"Temp: {placeholderS:7}\u00B0C", font=big_font)
...
label_wind = tk.Label(info_block, text=f"Wind: {placeholderN:.2f} km/h", font=big_font)
